 ...
 *
 */
private[bigdata] class HuemulControlModel(huemulBigDataGov: HuemulBigDataGovernance, controlVersionFull: Integer) extends Serializable {

  //Constructor
  val _huemulBigDataGov: HuemulBigDataGovernance = huemulBigDataGov
