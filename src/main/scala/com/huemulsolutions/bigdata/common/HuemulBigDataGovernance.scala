 ...
 */
class HuemulBigDataGovernance(appName: String, args: Array[String], globalSettings: HuemulGlobalPath, LocalSparkSession: SparkSession = null) extends Serializable  {
  ...
  @transient val impala_connection = new HuemulJDBCProperties(this, GlobalSettings.getPath(this, GlobalSettings.IMPALA_Setting),"com.cloudera.impala.jdbc4.Driver", DebugMode)
  ...
  def getHive_HWC: HuemulExternalHWC = { hive_HWC}
...
/*  
  ...
  */
  ...
  def DF_SaveLineage(Alias: String, sql: String, dt_start: java.util.Calendar, dt_end: java.util.Calendar, Control: HuemulControl, FinalTable: HuemulTable, isQuery: Boolean, isReferenced: Boolean ) {
  ...
  def DF_ExecuteQuery(Alias: String, SQL: String, Control: HuemulControl ): DataFrame = {
